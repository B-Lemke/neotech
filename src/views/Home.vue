...
const pages = reactive([
    ...
    new Page("30F. Non Smoker, Social Drinker. 5’2” Bisexual. ",authors.OliviaSoliz, ["thirtyf", "30f"],  "/thirtyf"),
    new Page("Playwriting Idea Generator", authors.BroderickLemke, ["inspiration", "stuck"], "/stuck"),
])
...
<template>
  <div class="p-5">
        <div class="row bg-lime-lighten-5 rounded elevation-3 p-2">
            <h2 class="my-2">Digital Theater Hub! <v-icon icon="rebase_edit" class="" /></h2>
            ...
            <div v-if="unlocked">
               <h3>Navigation:</h3>
                <v-data-table :items="pages"></v-data-table>
